...
const Home = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row w-full sm:w-[90%] md:w-[70%] h-[100vh] sm:h-[450px] md:h-[550px] rounded-none sm:rounded-lg overflow-scroll bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 relative mb-5">
